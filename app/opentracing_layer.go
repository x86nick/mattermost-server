...
func (a *OpenTracingAppLayer) UpdateConfigSubpath(path string) *model.AppError {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.UpdateConfigSubpath")
	...
	defer span.Finish()
	resultVar0 := a.app.UpdateConfigSubpath(path)
